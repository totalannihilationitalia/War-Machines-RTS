...
featuredefs = {
  dead = {
               world = "All Worlds",
               description = "Livrium truck Wreckage",
               category = "corpses",
               object = "ARMCV_DEAD",
               featuredead = "ruspa_camion_heap",
  ...
  heap = {
               world = "All Worlds",
               description = "Livrium truck Heap",
               category = "heaps",
               object = "3X3C",
               footprintx = 3,
               footprintz = 3,
