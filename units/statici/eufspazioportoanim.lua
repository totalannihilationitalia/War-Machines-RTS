...
--
--
-- Questa unità parcheggia il primo aereo sul pad. Serve solo come animazione di scarico nelle missioni (l'animazione parte appena viene creato)
--
--
--
...
--               buildangle = 1024,
               ...
               buildpic = "eufspazioportodin.pcx",
               buildtime  = 1224,
               canmove = true,
               canPatrol = true,
--               canstop = 1,
