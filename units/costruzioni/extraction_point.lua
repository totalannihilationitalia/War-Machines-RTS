...
--               movementclass = "BOAT5",
               ...
               noAutoFire = false,
               nochasecategory = "ALL",
               objectname = "extraction_point.s3o",
--               scale = 0.5,
               seismicsignature = 0,
...
featuredefs = {
  dead = {
               world = "All Worlds",
               description = "Extraction Point Wreckage",
               category = "corpses",
               object = "ARMTSHIP_DEAD",
               featuredead = "extraction_point_heap",				-- ########################## sistemare
               footprintx = 5,
               footprintz = 5,
               height = 4,
               blocking= false,
...
--               collisionvolumetype = ,
  ...
  heap = {
               world = "All Worlds",
               description = "Extraction Point Heap",
               category = "heaps",
               object = "5X5A",
               footprintx = 2,
               footprintz = 2,
