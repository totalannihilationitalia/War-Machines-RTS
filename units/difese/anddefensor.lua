...
--               mass = 0 --definire massa,
               ...
               maxwaterdepth = 0,
               metalStorage = 0,
               name = "Nuclear Defensor",
               objectname = "anddefensor.s3o",
               radardistance = 50,
               seismicsignature = 0,
...
featuredefs = {
  dead = {
               world = "All Worlds",
               description = "Nuclear defensor Wreckage",
               category = "corpses",
               object = "ARMAMD_DEAD",
               featuredead = "anddefensor_heap",
  ...
  heap = {
               world = "All Worlds",
               description = "Nuclear defensor  Heap",
               category = "heaps",
               object = "5X5B",
               footprintx = 5,
               footprintz = 5,
