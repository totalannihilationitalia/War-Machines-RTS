return {
	kicucom = {
		...
		canmove = true,
		capturespeed = 900,
		category = "ALL COMMANDER WEAPON NOTSUB NOTSHIP NOTAIR SURFACE",
		cloakcost = 100,
 ...
 sfxtypes = {
	...
	[[custom:azzurroflare]],
	[[custom:Nano]],
	[[custom:rocketflare]],  -- eliminare questo effetto e correggere lo script per l'azzurroflare
    },
  },
