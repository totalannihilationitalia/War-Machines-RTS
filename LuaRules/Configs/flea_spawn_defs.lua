...
maxChicken           = Spring.GetModOptions().mo_maxfleas*1
...
queenName            = "juju"   -- il nome del boss finale era "fleagoth" // 16/11/2024
...
queenTime            = Spring.GetModOptions().mo_gothtime*60 -- time at which the queen appears, seconds
...
local defenders = {
  omegat =  {time =  5,  squadSize = 0.5, obsolete = 15},
  omegaa =  {time =  15,  squadSize = 0.5, obsolete = 60},
