...
-- inserisco UnitUnitCollision 23/10/2019 ************************************************
function gadgetHandler:UnitUnitCollision(colliderID, collideeID)
 ...
 -- return -- nell'altro file non c'è
end

-- inserisco UnitFeatureCollision 23/10/2019 ************************************************
...
-- aggiungo function gadgetHandler 23/10/2019
...
-- sostituisco r_ipairs con ipairs 23/10/2019
