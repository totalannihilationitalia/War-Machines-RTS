...
function gadget:Initialize()
    ...
    for i = 1, #teamList do
        ...
        if teamSide == 'nfa' then
                spSetTeamRulesParam(teamID, startUnitParamName, nfacomDefID)


		elseif teamSide == 'kicu' then
				spSetTeamRulesParam(teamID, startUnitParamName, kicucomDefID)


		elseif teamSide == 'knfa' then
				spSetTeamRulesParam(teamID, startUnitParamName, knfacomDefID)
