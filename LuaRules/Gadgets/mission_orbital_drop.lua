  ...
  for unitID, controlValue in pairs(units) do
    if Spring.ValidUnitID(unitID) then
      ...
      elseif y < brakeAltitude+10  then
        -- unit is braking
		if frame % 2 == 0 then
			Spring.SpawnCEG("MEDIUMFLARE", x, y - 20, z) -- black dust
			Spring.SpawnCEG("MEDIUMFLARE", x + 10, y - 40, z + 10) -- braking thrusters
			Spring.SpawnCEG("MEDIUMFLARE", x - 10, y - 40, z + 10)
			Spring.SpawnCEG("MEDIUMFLARE", x + 10, y - 40, z - 10)
			Spring.SpawnCEG("MEDIUMFLARE", x - 10, y - 40, z - 10)
		end
		...
		--end
	  	...
	  	-- unit is falling
		if frame % 2 == 0 then
			Spring.SpawnCEG("MEDIUMFLARE", x, y - 40, z) -- meteor trail
		end
      end
    else
