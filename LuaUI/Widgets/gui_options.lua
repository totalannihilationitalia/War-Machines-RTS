...
function widget:ViewResize()
  ...
  screenX = (vsx*0.5) - (screenWidth/2) -- posizionamento x al centro dello schermo
  screenY = (vsy*0.5) + (screenHeight/2) -- posizionamento y al centro dello schermo
...
-- button
local textSize		= 0.75 -- altezza carattere "option"
local textMargin	= 0.25 -- posizione testo dal margine inferiore
local lineWidth		= 0.0625 -- boh

local posX = 0.02--  era 0.15, posizione x da dal margine sx del pulsante option
local posY = 0.17 -- posizione y dal fondo del pulsante Option
