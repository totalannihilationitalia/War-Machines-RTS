...
-- modified by molix 02/12/2024 rev4.WMRTS -> add close and back buttons and logic. Removed dragging, add auto set position on change resolution


local posX, posY					  	= 600, 400
local buttonsize					  	= 16 
local width, height					  	= 400, 560  -- larghezza e altezza dello sfondo menù opzioni
local iWidth							= 400
local iRowHeight						= 14
local rows								= 0
local height0							= 160
...
local buttons_back						= "LuaUI/Images/menu/menu_back.png" -- icona back to main menu button
local buttons_close						= "LuaUI/Images/menu/menu_close.png"-- icona close menu button
...
--------------------------------------------------------------------------------			 
-- Tweak-mode --eliminato con revisione 02/11/2024 molixx
--------------------------------------------------------------------------------
--[[
