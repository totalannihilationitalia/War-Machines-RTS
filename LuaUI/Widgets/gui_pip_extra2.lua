...
local panelBorderColorLight = {1, 0, 0, 1}		-- rosso
local panelBorderColorDark = {0.5, 0, 0, 1}	-- rosso scuro
...
----------------------------------------------------------------------------------------------------
-- Base variables
local DEFAULT_PL, DEFAULT_PR, DEFAULT_PB, DEFAULT_PT = 580+3, 776+3, 828, 1006
...
function widget:TextCommand(cmd)
	...
	if cmd == "open_WMRTS_camera_3" then
		inMinMode = false -- Mostra la telecamera 
		return true
	elseif cmd == "close_WMRTS_camera_3" then
	...
	elseif cmd == "reset_camera3_state" then
