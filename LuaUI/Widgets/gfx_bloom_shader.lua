...
-- UTILIZZATO IN WMRTS si può abilitare dal menu
...
local blurPasses = 1 --1				-- how many iterations of Gaussian blur should be applied to the glow sources?
...
local WMRTSopt_BOOM = 0 -- aggiunto per opzioni
...
--       WMRTS_ShowNoobbuttons = Spring.GetConfigInt("WMRTS_ShowNoobButtons",1)
--	if (WMRTS_ShowNoobbuttons == 0) then
--		Spring.Echo("il valore è 0 pertanto non partooo") -- for debug ############################################
--		return
--	end

-- imposto in springsettings.cfg l'opzione WMRTS_ShowNoobButtons == 1
--	Spring.SetConfigInt("WMRTS_ShowNoobButtons",1)
--	Spring.Echo("boom shader attivo debug, inviare variabile") -- for debug ############################################
...
--	Spring.Echo("boom shader disattivato debug, inviare variabile") -- for debug ############################################
