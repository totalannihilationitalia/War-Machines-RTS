...
local blinkPeriod = 0.35 -- lampeggio, più è basso il valore più è veloce
local ttl = 35 -- tempo in cui l'indicatore su mappa e su visuale rimane in vista
local highlightSize = 32
local highlightLineMin = 24
local highlightLineMax = 40
local edgeMarkerSize = 16
local lineWidth = 2 --linee visualizzabili sulla minimap
local maxAlpha = 1
local fontSize = 16
