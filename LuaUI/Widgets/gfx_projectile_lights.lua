...
local pieceprojectilecolor={1.0, 1.0, 0.5, 0.05} -- This is the color of piece projectiles, set to nil to disable
	...
	for w=0, #WeaponDefs do 
		...
		if not BlackList[weaponDef.name] then	-- prevent projectile light, if the weapon has some other light effect
			...
			elseif (weaponDef.type == 'LightningCannon') then
				local colour = weaponDef.visuals
-- modifico da 0.75 a 0.35 il canale alpha **********************************************************************************************************************************
				plighttable[w] = {colour.colorR, colour.colorG, colour.colorB, 0.15, true, 64*colour.thickness^0.45, 1.1}					
